                                ...
                                <tbody>
                                    {orders && orders.map((order) => (
                                        <tr key={order._id} className="border-b hover:bg-gray-50">
                                            ...
                                            <td className="p-4">
                                                <span className={`px-2 py-1 rounded-full text-xs font-medium ${order.paymentMethod === 'Razorpay' || order.paymentMethod === 'Online' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                                                    }`}>
                                                    {order.paymentMethod}
                                                </span>
                                            </td>
